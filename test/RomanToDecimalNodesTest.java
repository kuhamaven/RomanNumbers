...
public class RomanToDecimalNodesTest {

    private void testRomanNumberToDecimal(String romanNumber, int expected) {
        int result = Nodes.RomanToDecimal.convert(romanNumber);
    ...
    @Test
    public void test17_GivenALongerStringThanPossibleShouldReturnNegative1(){
        testRomanNumberToDecimal("MMMDCCCLXXXVIIII",-1);
    }

    @Test
    public void test18_GivenAnInvalidSymbolShouldReturnNegative1(){
        testRomanNumberToDecimal("MMMK",-1);
    }

    @Test
    public void test19_GivenAnInvalidNumberShouldReturnNegative1(){
        testRomanNumberToDecimal("DM",-1);
    }
